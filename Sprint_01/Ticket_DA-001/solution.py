...
valid_items["net_amount"] = valid_items["gross_amount"] * (
    1 - valid_items["discount_pct"] / 100
)
...
grouped_customer = (
    final_dataframe.groupby(
        ["customer_id", "first_name", "last_name", "country", "segment"]
    )
    .agg(
...
grouped_customer = grouped_customer.sort_values(by="total_revenue", ascending=False)
